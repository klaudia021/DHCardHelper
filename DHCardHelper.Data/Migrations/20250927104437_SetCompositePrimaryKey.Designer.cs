...
namespace DHCardHelper.Data.Migrations
{
    ...
    [Migration("20250927104437_SetCompositePrimaryKey")]
    partial class SetCompositePrimaryKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DHCardHelper.Models.Entities.Characters.CardSheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("InLimit")
                        .HasColumnType("bit");

                    b.Property<bool>("InLoadout")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DHCardHelper.Models.Entities.Characters.CharacterSheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DHCardHelper.Models.Entities.Relationships.ClassToDomainRel", b =>
                {
                    ...
                    b.HasKey("ClassId", "DomainId");

                    b.HasIndex("DomainId");

                    b.ToTable("ClassToDomainRel");
                });

            modelBuilder.Entity("DHCardHelper.Models.Entities.Users.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DHCardHelper.Models.Entities.Characters.CardSheet", b =>
                {
                    b.HasOne("DHCardHelper.Models.Entities.Cards.Card", "Card")
                        .WithMany()
                        .HasForeignKey("CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DHCardHelper.Models.Entities.Characters.CharacterSheet", "CharacterSheet")
                        .WithMany()
            ...
            modelBuilder.Entity("DHCardHelper.Models.Entities.Characters.CharacterSheet", b =>
                {
                    b.HasOne("DHCardHelper.Models.Entities.Users.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DHCardHelper.Models.Entities.Users.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
